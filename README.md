...
- `SCNativeRulePlotChart` (`iOS 18+`, `macOS 15+`, `tvOS 18+`, `watchOS 11+`, `visionOS 2+`)
- `SCNativeSectorPlotChart` (`iOS 18+`, `macOS 15+`, `tvOS 18+`, `watchOS 11+`, `visionOS 2+`)
- `SCNativeDonutPlotChart` (`iOS 18+`, `macOS 15+`, `tvOS 18+`, `watchOS 11+`, `visionOS 2+`)
