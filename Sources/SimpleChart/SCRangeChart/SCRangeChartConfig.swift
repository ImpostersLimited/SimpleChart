...
/// Deprecated legacy configuration container for the original range-chart API.
public struct SCRangeChartConfig {
    ...
    /// Creates a legacy range-chart configuration value for compatibility with the original API surface.
