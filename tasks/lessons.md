...
- When availability-gating source behind a compiler-version check, mirror that guard in test files too; docbuild and older CI toolchains will still compile tests.
